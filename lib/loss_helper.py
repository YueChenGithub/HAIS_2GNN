...
def get_loss(data_dict, config):
    ...
    Returns:
        ...
        data_dict: dict
    """
    lang_loss = compute_lang_classification_loss(data_dict) #l
    data_dict["lang_loss"] = lang_loss #l
    seg_loss, seg_acc = compute_scene_mask_loss(data_dict) #3
    ...
    attribute_scores = data_dict['attribute_scores'] #1
    relation_scores = data_dict['relation_scores'] #2
    scene_scores = data_dict['scene_scores'] #3
    ...
    for i in range(batch_size):
        ...
        attribute_score = attribute_scores[start_idx:start_idx + num_filtered_obj] #1
        relation_score = relation_scores[start_idx:start_idx + num_filtered_obj] #2
        scene_score = scene_scores[start_idx:start_idx + num_filtered_obj] #3
        score = attribute_score + relation_score + scene_score #123
    ...
    data_dict['loss'] = 10 * ref_loss + lang_loss + seg_loss #123
    data_dict["seg_loss"] = seg_loss #3
    data_dict['seg_acc'] = seg_acc #3
